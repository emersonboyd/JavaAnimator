...
public class AbstractShapeTest {
  ...
  @Test
  public void testShapeNameCannotHaveASpace() {
    try {
      AbstractShape illegalShape = new Rectangle(1,2, "at t=", this.p, this.c, 30, 30);
      fail();
    } catch (IllegalArgumentException e) {
      assertEquals(AbstractShape.ERROR_NAME_HAS_SPACE, e.getMessage());
    }
  }
}
