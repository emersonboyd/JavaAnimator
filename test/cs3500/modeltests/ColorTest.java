...
public class ColorTest {
  ...
  @Test
  public void testTransformToAwt() {
    java.awt.Color color = new java.awt.Color(0.5f, 0.3f, 0.2f);

    assertEquals(color, c.transformToAwt());
  }

  @Test
  public void testToSVG() {
    assertEquals("rgb(128,77,51)", c.toSVG());
  }

  @Test
  public void testParseString() {
    assertEquals("(0.4,1.0,0.0)", Color.parseString("(0.4,1.0,0.0)").toString());
  }
}